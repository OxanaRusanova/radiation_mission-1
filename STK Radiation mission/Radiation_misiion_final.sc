...
BEGIN Scenario
    Name		 Radiation_misiion_final

    BEGIN Epoch

        Epoch		 22 Feb 2018 09:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 22 Feb 2018 09:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 22 Feb 2018 09:00:00.000000000
        Stop		 9 Nov 2018 09:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 22 Feb 2018 09:00:00.000000000
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            ...
            Style		 Access
            AGIViewer		 Yes
            Instance		 Facility/ScanEx_Irkutsk_Station
            BEGIN InstanceList
            ...
            WindowRectLeft		 324
            WindowRectTop		 220
            WindowRectRight		 1817
            WindowRectBottom		 692
        END Report
        ...
        BEGIN Report
            ...
            Style		 Access
            AGIViewer		 Yes
            Instance		 Facility/ScanEx_Moscow_Station
            BEGIN InstanceList
                Instance		 Facility/ScanEx_Irkutsk_Station
            END InstanceList
            BEGIN TimeData
        ...
        BEGIN Report
            ...
            Style		 Access
            AGIViewer		 Yes
            Instance		 Satellite/Satellite1/Transmitter/Transmitter1
            BEGIN InstanceList
                Instance		 Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1/Receiver/Receiver1
            END InstanceList
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
        ...
        BEGIN Report
            ...
            Instance		 Satellite/Satellite1
            BEGIN InstanceList
                Instance		 Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1
            END InstanceList
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 22 Feb 2018 09:00:00.000000000
                    Stop		 23 Feb 2018 09:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<VAR name = "STK_Radar_Clutter_Extension">
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 22 Feb 2018 09:00:00.000000000
                EndTime		 9 Nov 2018 09:00:00.000000000
                CurrentTime		 25 Feb 2018 10:00:00.000000000
                Direction		 Forward
                UpdateDelta		 1800
    ...
    BEGIN SubObjects
        ...
        Class Facility
            ...
            ScanEx_Irkutsk_Station		
            ScanEx_Moscow_Station		
    ...
    BEGIN References
        ...
        END Instance
        Instance Facility/ScanEx_Irkutsk_Station
            Facility/ScanEx_Irkutsk_Station		
            Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1		
        END Instance
        Instance Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1
            Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1		
            Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1/Receiver/Receiver1		
        END Instance
        Instance Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1/Receiver/Receiver1
            Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1/Receiver/Receiver1		
        END Instance
        Instance Facility/ScanEx_Moscow_Station
            Facility/ScanEx_Moscow_Station		
        END Instance
        Instance Satellite/Satellite1
            Facility/ScanEx_Irkutsk_Station/Sensor/Sensor1		
            Satellite/Satellite1		
            Satellite/Satellite1/Transmitter/Transmitter1		
        END Instance
        Instance Satellite/Satellite1/Transmitter/Transmitter1
            Satellite/Satellite1/Transmitter/Transmitter1		
        END Instance
